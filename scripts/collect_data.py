...
def run_experiment(distance, angle, user_id):
...
if __name__ == "__main__":
    ...
    parser.add_argument('--distance_to_curve', required=True,
                        help='distance in mm')
    parser.add_argument('--angle_curve', required=True,
                        help='angle')
    ...
    run_experiment(distance=args.distance_to_curve, angle=args.angle_curve, user_id=args.experiment_id)
    #else:
    #    print('control strategy not found, please use one of the following:')